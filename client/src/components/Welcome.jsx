...
const Welcome = () => {
  ...
  const Input = React.memo(({ placeholder, name, type, value, handleChange }) => {
    return(<input
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96  w-full flex flex-col justify-start items-centre blue-glassmorphism h-80  ">
            ...
            <div className="h-[1px] w-full bg-gray-400 my-2 ">
              {isLoading ? (
                ...
                <button
                  ...
                  className="text-white w-full mt-4 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer"
                >
                  Send Now
                </button>
              )}
